...
votar_pelicula_bp = Blueprint(
    "votar_pelicula",
    __name__,
    url_prefix="/evento/votar_pelicula"
)
...
def get_ip():
    ...
    Prioriza X-Forwarded-For, luego X-Real-IP, y finalmente remote_addr.
    """

    x_forwarded_for = request.headers.get("X-Forwarded-For")
    if x_forwarded_for:
        # Puede contener varias IPs: cliente, proxy1, proxy2
